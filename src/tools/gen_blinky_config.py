...
def get_memories():
    ...
    memories["ram"] = {"base_addr": 0x20000000, "size": 0x14000, "name": "ram"}
...
if __name__ == "__main__":
    ...
    p = ArgumentParser()
    p.add_argument("-c", "--config", type=str, help="Output name for config file (.yaml)")
    args = p.parse_args()
    main(args.config)
