...
if __name__ == "__main__":
    ...
    p = ArgumentParser()
    p.add_argument("-f", "--filename", help="Input filename to run parser over")
    p.add_argument("-d", "--dir", help="Input directory to run parser over")
    p.add_argument(
        "-o", "--output_file", required=True, help="Filename to write output configuration to"
    )
