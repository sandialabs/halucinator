...
class ARPSender(object):
    def __init__(self, ioserver, host_interface=None):
        ...
        self.ioserver.register_topic("Peripheral.EthernetModel.tx_frame", self.received_frame)
...
if __name__ == "__main__":
    ...
    p.add_argument(
        "-i", "--interface", default="eth0", help="Ethernet Interace in halucinator to send to"
    )
    p.add_argument("--host", help="Host Ethernet interace to mirror frames on")
    args = p.parse_args()
