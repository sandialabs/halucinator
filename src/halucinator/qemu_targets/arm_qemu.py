...
class ARMQemuTarget(QemuTarget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self._arch.keystone_arch = KS_ARCH_ARM
        # # Make big endian, because host is BE, otherwise have to reverse everything
    ...
    def irq_set_qmp(self, irq_num=1):
        ...
        self.protocols.monitor.execute_command(
            "pmemwrite", args={"pmem_addr": addr, "data_buff": "01"}
        )
    ...
    def irq_clear_qmp(self, irq_num=1):
        ...
        addr = self.get_irq_base_addr() + irq_num
        self.protocols.monitor.execute_command(
            "pmemwrite", args={"pmem_addr": addr, "data_buff": "00"}
        )
    ...
    def set_bp(self, addr, handler_cls, handler, run_once=False):
        ...
        config = {"cls": cls_name, "run_once": run_once, "function": handler, "addr": addr}
