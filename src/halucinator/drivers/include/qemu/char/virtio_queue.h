#ifndef __VIRTIO_QUEUE_H_
#define __VIRTIO_QUEUE_H_
// Also see: https://www.redhat.com/en/blog/virtqueues-and-virtio-ring-how-data-travels
/*
 *
...
static inline void virtio_init_queue(volatile uint8_t* buf, uint32_t n, volatile struct virtq* q)
{
    q->num = n;
    q->desc = (struct virtq_desc*)buf;
    q->avail = (struct virtq_avail*)(buf + VIRTIO_QUEUE_AVAIL_OFFSET(n));
    q->used = (struct virtq_used*)(buf + VIRTIO_QUEUE_USED_OFFSET(n, PG_SIZE));
    q->avail->idx = 0;
    q->used->idx = 0;
}
