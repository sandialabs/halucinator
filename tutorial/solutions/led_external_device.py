...
#  This is our extenal device calass that is going to handle LEDs
...
def main():
    ...
    p.add_argument("-i", "--id", default=0x20000AB0, type=int, help="Id to use when sending data")
